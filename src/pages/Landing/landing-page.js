...
const LandingPage = () => {
    ...
    return (
        <section  className="flex-col justify-center items-center w-screen ps-5 flex bg-gradient-to-r from-rose-400 to-orange-300 dark:from-slate-900 dark:via-purple-900 dark:to-slate-900 text-white py-10">
