...
const DayNightToggle = ({ handleThemeSwitch }) => {
    return (
        <div
            ...
            className="hidden cursor-pointer rounded-full shadow-md transition-all duration-1000 md:block absolute w-[70px] md:right-24 dark:bg-gradient-to-br dark:from-gray-600 dark:via-gray-700 dark:to-gray-800 bg-gradient-to-b from-cyan-300 to-cyan-400"
        >
