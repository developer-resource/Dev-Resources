    ...
    <div className="container mb-5 ">
      ...
      <div className="row mx-auto jobDiv pt-3">
        ...
        <div className="row mt-5 showDiv" style={{ display: more ? 'block' : 'none' }}>
          <div className='col-12'>
            <div className="h6 mb-4 fw-bold text-capitalize">Type : <span className='fw-light'>{props.type}</span></div>
            <div className="h6 mb-4 fw-bold text-capitalize">Start Date : <span className='fw-light'>{props.startDate}</span></div>
            <div className="h6 mb-4 fw-bold text-capitalize">Duration : <span className='fw-light'>{props.duration}</span></div>
            <div className="h6 mb-4 fw-bold text-capitalize">Batch : <span className='fw-light'>{props.batch}</span></div>
            <div className="h6 mb-4 fw-bold text-capitalize">Experience : <span className='fw-light'>{props.experience}</span></div>
