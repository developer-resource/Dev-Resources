...
const ProjectCard = ({ values }) => {
    ...
    return (
        <div className='text-black w-screen md:w-8/12 lg:w-1/2 flex flex-col gap-8 pb-5 overflow-hidden duration-500 rounded-lg dark:text-white bg-white shadow-md dark:bg-[rgba(255,255,255,.1)]' >
            {/* Thumnail */}
            <div>
                <img
                    src={thumbnail}
                    className='h-60 lg:h-96 w-[100%]'
