...
const JobCard = ({ values }) => {
    ...
    return (
        <div className='text-black w-[93%] md:w-[70%] xl:w-[35%] 2xl:w-[30%] cursor-pointer hover:scale-105 transition-all duration-500 rounded-lg dark:text-white p-5 bg-white shadow-md dark:bg-[rgba(255,255,255,.1)]'>
...
const JobCardWrapper = () => {
    ...
    return (
        <div className='flex ms-1 items-center flex-wrap gap-8 md:mt-3 xl:mt-5 justify-center'>
